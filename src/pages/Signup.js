...
const Signup = () => {
  ...
  const addProfile = async (e) => {
    ...
    const response = await fetch('http://172.25.25.166:3000/authors/add', {
      method: 'POST',
      headers: {
        ...
        <div class=''>
          ...
          <form>
            <div class="form-outline mb-4">
              ...
              <input ref={signnameRef} type="name" class="form-control" name='name' placeholder='Enter name' autoComplete='off' />

            </div>
            <div class="form-outline mb-4">
              <label class="form-label" >Email address</label>
              <input ref={signemailRef} type="email" class="form-control" name='email' placeholder='Enter email' autoComplete='off' />

            </div>
            <div class="form-outline mb-4">
              <label class="form-label" >Password</label>
              <input ref={signpassRef} type="password" class="form-control" name='password' placeholder='Create a password' autoComplete='off' />

            </div>

            <div class="form-outline mb-4">
              <label class="form-label" >Confirm Password</label>
              <input ref={signcnfmpassRef} type="password" class="form-control" name='password' placeholder='Again enter password' autoComplete='off' />

            </div>

            <button type="button" onClick={e => addProfile(e)} class="btn btn-block mb-4 w-100" style={{ background: "#7F56D9", color: "#FFFFFF" }}>Sign up</button>
